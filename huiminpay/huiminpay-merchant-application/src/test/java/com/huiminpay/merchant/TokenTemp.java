...
public class TokenTemp {
    ...
    public void createTestToken() {
                        //1428639378244161538
        Long merchantId = 1434892497257975809L;//填写用于测试的商户id
        ...
        System.out.println(jwt_token);//Bearer eyJtZXJjaGFudElkIjoxNDM0ODkyNDk3MjU3OTc1ODA5LCJ1c2VyX25hbWUiOiJhYSIsIm1vYmlsZSI6IjEzNjc2OTUwOTk3In0=
    }
}
